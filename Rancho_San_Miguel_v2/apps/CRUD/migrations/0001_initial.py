# Generated by Django 2.1.4 on 2019-06-06 14:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('Vientre en producción limousin', 'Vientre en producción limousin'), ('Vientre en crecimiento limousin', 'Vientre en crecimiento limousin'), ('Vientre en producción brangus', 'Vientre en producción brangus'), ('Vientre en crecimiento brangus', 'Vientre en crecimiento brangus'), ('Sementales', 'Sementales'), ('Becerros', 'Becerros')], max_length=20)),
